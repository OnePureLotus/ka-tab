...
test.describe('Settings – Appearance section', () => {
  // E2E-SE-01
  test('E2E-SE-01: options page loads showing "Appearance & Behavior" section by default', async ({ optionsPage: page }) => {
    await expect(page.getByText('Appearance & Behavior')).toBeVisible()
  })

  // E2E-SE-02
  test('E2E-SE-02: Theme section shows System / Light / Dark options', async ({ optionsPage: page }) => {
  ...
  test('E2E-SE-03: default (system) theme has no theme-light or theme-dark class on <html>', async ({ optionsPage: page }) => {
  ...
  // E2E-SE-04
  test('E2E-SE-04: clicking Dark adds theme-dark class to <html>', async ({ optionsPage: page }) => {
    await page.getByRole('button', { name: 'Dark' }).click()
    await expect(page.locator('html')).toHaveClass(/theme-dark/)
  })

  // E2E-SE-05
  test('E2E-SE-05: clicking Light adds theme-light class to <html>', async ({ optionsPage: page }) => {
    await page.getByRole('button', { name: 'Light' }).click()
    await expect(page.locator('html')).toHaveClass(/theme-light/)
  })

  // E2E-SE-06: System resets the theme
  test('E2E-SE-06: after setting Dark, clicking System removes theme-dark class', async ({ optionsPage: page }) => {
    await page.getByRole('button', { name: 'Dark' }).click()
    await expect(page.locator('html')).toHaveClass(/theme-dark/)
  ...
  test('E2E-SE-07: accent color preset buttons (Indigo, Green, Blue…) are visible', async ({ optionsPage: page }) => {
  ...
  test('E2E-SE-08: clicking the Green preset updates the displayed hex value', async ({ optionsPage: page }) => {
  ...
  test('E2E-SE-09: Open Collection section shows Tab Group and New Window options', async ({ optionsPage: page }) => {
  ...
  test('E2E-SE-10: selecting "New Window" mode does not throw an error', async ({ optionsPage: page }) => {
...
test.describe('Settings – Floating Button / Blocked Domains', () => {
  ...
  test('E2E-SE-12: typing a domain and pressing Enter adds a blocked-domain chip', async ({ optionsPage: page }) => {
  ...
  test('E2E-SE-13: removing a blocked domain chip deletes it from the list', async ({ optionsPage: page }) => {
    const input = page.getByPlaceholder('docs.google.com')
...
test.describe('Settings – Data & Backup section', () => {
  ...
  test('E2E-SE-15: clicking "Data & Backup" nav item shows the data section', async ({ optionsPage: page }) => {
    ...
    await expect(page.getByRole('heading', { name: /data/i }).or(page.getByText('Data & Backup').nth(1))).toBeVisible()
  })

  test('E2E-SE-16: Export Backup button is visible in the Data section', async ({ optionsPage: page }) => {
    await page.getByText('Data & Backup').first().click()
    await expect(page.getByRole('button', { name: 'Export Backup' })).toBeVisible()
  })

  test('E2E-SE-17: Import Backup button is visible in the Data section', async ({ optionsPage: page }) => {
    await page.getByText('Data & Backup').first().click()
...
test.describe('Settings – Privacy section', () => {
  ...
  test('E2E-SE-18: Privacy section shows "data stays in Chrome storage" text', async ({ optionsPage: page }) => {
    await page.getByText('Privacy').first().click()
    await expect(page.getByText(/data stays in chrome storage/i)).toBeVisible()
  })
})
